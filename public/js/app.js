...
var notifier = new (awesome_notifications__WEBPACK_IMPORTED_MODULE_0___default())(options); // Set custom options for next call if needed, it will override globals
// let nextCallOptions = {...}
...
function updateCart(pizza) {
  axios.post('/update-cart', pizza).then(function (res) {
    ...
    notifier.success("".concat(pizza.name, " added to cart"), options);
  });
}
