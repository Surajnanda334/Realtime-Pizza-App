          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                ...
                var e = Array.from(
                  this.parent.getElementsByClassName(c.prefix)
                );
                this.delete(
                  e.find(function (e) {
              ...
              if (
                ...
                for (
                  ...
                  this.addEvent(o, function () {
                    t.isDeleted() ||
                      (t.toggleClass(c.klass.progressBarPause),
                      t.timer.toggle());
                  });
                }
              }
    ...
    var S = (function (t) {
      function e(t) {
        ...
        return (
          ((n = _(
            this,
            T(e).call(this, document.body, u.ids.wrapper, null, s, i)
          ))[u.ids.confirmOk] = r),
          (n[u.ids.confirmCancel] = a),
          (n.className = "".concat(u.prefix, "-").concat(o)),
            ...
            value: function (t) {
              ...
              switch (this.type) {
                case "confirm":
                  var n = [
                    "<button class='"
                      .concat(u.klass.button, " ")
                      .concat(u.klass.successBtn, "'id='")
                      .concat(u.ids.confirmOk, "'>")
                      .concat(this.options.labels.confirmOk, "</button>"),
                  ];
                  !1 !== this[u.ids.confirmCancel] &&
                    n.push(
                      "<button class='"
                        .concat(u.klass.button, " ")
                        .concat(u.klass.cancelBtn, "'id='")
                        .concat(u.ids.confirmCancel, "'>")
                        .concat(this.options.labels.confirmCancel, "</button>")
                    ),
                    (e = ""
                      .concat(this.options.icon(this.type), "<div class='")
                      .concat(u.klass.title, "'>")
                      .concat(
                ...
                case "async-block":
                  e = ""
                    .concat(e, '<div class="')
                    .concat(u.klass.dotAnimation, '"></div>');
              }
            ...
            value: function (t) {
              ...
              switch (t.code) {
                ...
                case "Tab":
                  if (
                    (t.preventDefault(),
                    "confirm" !== this.type || !1 === this[u.ids.confirmCancel])
                  )
                    return !0;
                  var e = this.okBtn;
                  t.shiftKey
                    ? document.activeElement.id == u.ids.confirmOk &&
                      (e = this.cancelBtn)
                    : document.activeElement.id !== u.ids.confirmCancel &&
                      (e = this.cancelBtn),
                    e.focus();
              }
            },
